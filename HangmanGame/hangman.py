...
try:
    hangman = Hangman("fruit", "hard") # (Category, Difficulty) Categories: fruit, vegetable, animal. Difficulties: easy, normal, hard.
    hangman.welcome_message()
    hangman.start_the_game()
